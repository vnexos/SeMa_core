...
/**
 * Provides engine for H2 database
 * 
 * @author Trần Việt Đăng Quang
 * @see DatabaseEngine
 */
public class H2Engine implements DatabaseEngine {
  ...
  public String generateCreateDatabase(String databaseName) throws SQLException {
    // H2 does not support CREATE DATABASE; databases are created by connecting to a
    // URL
    return "";
  }
